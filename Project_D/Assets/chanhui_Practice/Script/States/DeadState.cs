...
{
    protected S_DeadState stateData;
    public DeadState(Entity entity, FSM stateMachine, string animBoolName, S_DeadState stateData) : base(entity, stateMachine, animBoolName)
    {
